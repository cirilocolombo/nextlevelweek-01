...
//-- Sempre que um estado usar array ou objeto, deve definir o tipo (TS)
interface Item {
  id: number;
  title: string;
  image_url: string;
...
const CreatePoint = () => {
  ...
  async function handleSubmit(event: FormEvent) {
    //-- Previne que faça reload na tela
    ...
    <div id="page-create-point">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <fieldset>
          ...
          <Map center={initialMapPosition} zoom={14} onClick={handleMapClick}>
            <TileLayer
        ...
        <fieldset>
          ...
          <ul className="items-grid">
            {items.map(item => (
              <li
                key={item.id}
                onClick={() => handleSelectItem(item.id) /*Sempre que precisar passar parm para funcão, chamar outra antes*/}
